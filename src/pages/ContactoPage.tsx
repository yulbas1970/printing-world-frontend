...
const ContactoPage = () => {
  ...
  const translations = {
    en: {
      title: 'Contact Us',
      subtitle: 'Ready to transform your space? Get in touch!',
    },
    es: {
      title: 'Contáctanos',
      subtitle: '¿Listo para transformar tu espacio? ¡Ponte en contacto!',
    },
  };
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8">
              ...
              >
                ...
                <textarea
                  ...
                  rows={5}
                  name="message"
                  className="w-full p-4 rounded-lg bg-white/10 border border-white/30 focus:border-yellow-400 outline-none resize-none"
                />

                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-gradient-to-r from-yellow-400 to-orange-500 text-black py-4 rounded-xl font-bold text-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
